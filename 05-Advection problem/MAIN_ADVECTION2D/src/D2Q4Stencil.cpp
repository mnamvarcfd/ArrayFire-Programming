...
D2Q4Stencil::D2Q4Stencil(Field& field_):Stencil(field_)
{
...
void D2Q4Stencil::set_coeff2D(double **coeff2D_)
{
	...
	coeff1D[2] = coeff2D_[2][1];
	coeff1D[3] = coeff2D_[1][0];
	coeff1D[4] = coeff2D_[0][1];

}


void D2Q4Stencil::get_iNeib(int iNode, int* iNeib)
{
	int iNeibTmp[9];
